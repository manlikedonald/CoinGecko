...
import nft from '../../assets/images/mzk-port.webp'
import nftTwo from '../../assets/images/sven-eberwein.webp'
                ...
                <div className="body">
                    <div className="defi-body">
                        <div className="middle">
                            <h1 style={{textAlign: 'center'}}><b>NFT Spotlight</b></h1>
                        </div>
                        <br />
                        <div className='grid-container'>
                            {
                                grid.map((item, index) => 
                                    <div className='grid' key={index + 1}>
                                        ...
                                        <h2><span><b>{item.num}</b></span> {item.header}</h2>
                                        <br />
                                        <p>{item.text}</p>
                                    </div>    
                                )
